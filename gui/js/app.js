...
$(function() {
    ...
    var loginValidationSettings = {
	    ...
	    messages: {
	        username: {
	            required: "Porfavor preencha o campo usuário",
	            //email: "Porfavor preencha o campo usuário com um usuário válido"
	        },
	        password:  "Porfavor preencha o campo senha",
	        agree: "Porfavor aceite as nossas regras"
	    },
...
$(function() {
    ...
    var resetValidationSettings = {
	    ...
	    messages: {
	        email1: {
	            required: "Porfavor preencha o campo email",
	            email: "Porfavor preencha o campo email com um email válido"
	        }
	    },
	    invalidHandler: function() {
			animate({
...
$(function() {
    ...
    var signupValidationSettings = {
	    ...
	    messages: {
	    	firstname: "Porfavor preencha o campo nome e sobrenome",
	    	lastname: "Porfavor preencha o campo nome e sobrenome",
	        email: {
	            required: "Porfavor preencha o campo email",
	            email: "Porfavor preencha o campo email com um email válido"
	        },
	        password: {
	        	required: "Porfavor preencha o campo senha e confirmar senha",
	        	minlength: "O campo senha precisa ter ao menos 8 caracteres."
	        },
	        retype_password: {
	        	required: "Porfavor preencha o campo senha e confirmar senha",
	        	minlength: "O campo senha precisa ter ao menos 8 caracteres"
	        },
	        agree: "Porfavor aceite nossa política"
	    },
	    invalidHandler: function() {
			animate({
				name: 'shake',
